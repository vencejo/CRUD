...
def creaDb(password):
    ...
    try:
        ...
        query = 'CREATE DATABASE DBdeConan5'
        cursor.execute(query)
        query = "GRANT ALL ON DBdeConan5.* TO \"conan\"@\"localhost\" IDENTIFIED BY \"crom\""
        cursor.execute(query)
        query = 'USE DBdeConan5'
        cursor.execute(query)
...
class GUI:
    ...
    def __init__(self):
        ...
        self.tabla = Db(host='localhost', user='conan',passwd='crom', db='DBdeConan5')
